        ...
        <div class="calc-buttons" role="group" aria-label="Calculator buttons">
            <nav class="move-buttons">
                <button
                    class="move-button"
                    data-action="left"
                    aria-label="Move cursor left">&larr;</button
                >
                <button
                    class="move-button"
                    data-action="right"
                    aria-label="Move cursor right">&rarr;</button
                >
            </nav>
            ...
            <div
                ...
                role="grid"
                tabindex="0"
                aria-label="Calculator number pad"
            ...
            >
                <div class="calc-button-row">
                    ...
                    <button class="calc-button operator" data-action="delete"
                        >DEL</button
                    >
                    <button
                        class="calc-button double operator"
                ...
                <div class="calc-button-row">
                    ...
                    <button class="calc-button operator" data-action="add"
                        >&plus;</button
                    >
                ...
                <div class="calc-button-row">
                    ...
                    <button class="calc-button operator" data-action="sqrt"
                        >&radic;</button
                    >
                    <button class="calc-button operator" data-action="square"
                        >x²</button
                    >
                    <button
                        class="calc-button double operator"
                        data-action="equals">&equals;</button
                    >
                </div>
            </div>
        </div>
